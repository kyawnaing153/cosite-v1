        ...
        <main className="p-6">
          <div className="mb-6 flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600">Track material purchases for your sites</p>
            </div>
                  ...
                  {purchases?.map((purchase: Purchase) => (
                    <tr key={purchase.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{purchase.itemDescription}</div>
                        <div className="text-sm text-gray-500">{purchase.purchaseType}</div>
                      </td>
