                  ...
                  <CardContent className="space-y-6">
                    <div className="text-center">
                      <div className="flex items-center justify-center space-x-3 mb-4">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800">ConstructPro</h2>
                      </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <p className="text-sm text-gray-700">
                          Version 1.0.0 - Built with React, TypeScript, and Express.js
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">System Statistics</h4>
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{labour?.length || 0}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Active Sites:</span>
                            <span className="font-medium">
                              {sites?.filter((s: any) => s.status === 'on_progress').length || 0}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          <div>
                            ...
                            <span className="ml-2">support@constructpro.com</span>
                          </div>
                          <div>
